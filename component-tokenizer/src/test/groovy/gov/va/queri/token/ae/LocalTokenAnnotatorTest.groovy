...
class LocalTokenAnnotatorTest {
    ...
    public void smokeTest() {
        ...
        AnalysisEngineDescription desc = AnalysisEngineFactory.createEngineDescription(
            ...
            LocalTokenAnnotator.PARAM_LEMMATIZER_DICT, '/models/en-lemmatizer.dict',
        ...
        // create a new JCas and seed with sentences
        String text = "Exam extent reached: identified the cecum and visualized the ileocecal valve/appendiceal orifice."
        JCas jcas = tokenizer.newJCas()
        jcas.setDocumentText(text)
        jcas.create(type:Sentence, begin:0, end:text.length())
