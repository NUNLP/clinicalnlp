...
public class SegmentHeading_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.queri.types.SegmentHeading");
  ...
  public String getCode(int addr) {
      ...
      jcas.throwFeatMissing("code", "gov.va.queri.types.SegmentHeading");
  ...
  public String getCodeSystem(int addr) {
      ...
      jcas.throwFeatMissing("codeSystem", "gov.va.queri.types.SegmentHeading");
