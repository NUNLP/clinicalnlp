...
public class Token_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.queri.types.Token");
  ...
  public String getPos(int addr) {
      ...
      jcas.throwFeatMissing("pos", "gov.va.queri.types.Token");
  ...
  public String getLemma(int addr) {
      ...
      jcas.throwFeatMissing("lemma", "gov.va.queri.types.Token");
  ...
  public String getStem(int addr) {
      ...
      jcas.throwFeatMissing("stem", "gov.va.queri.types.Token");
