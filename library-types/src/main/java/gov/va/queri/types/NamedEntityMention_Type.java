...
public class NamedEntityMention_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.queri.types.NamedEntityMention");
  ...
  public String getCode(int addr) {
      ...
      jcas.throwFeatMissing("code", "gov.va.queri.types.NamedEntityMention");
  ...
  public String getCodeSystem(int addr) {
      ...
      jcas.throwFeatMissing("codeSystem", "gov.va.queri.types.NamedEntityMention");
  ...
  public String getProvenance(int addr) {
      ...
      jcas.throwFeatMissing("provenance", "gov.va.queri.types.NamedEntityMention");
  ...
  public int getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("polarity", "gov.va.queri.types.NamedEntityMention");
