...
public class DictMatch_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.queri.types.DictMatch");
  ...
  public int getMatched(int addr) {
      ...
      jcas.throwFeatMissing("matched", "gov.va.queri.types.DictMatch");
  ...
  public String getCanonical(int addr) {
      ...
      jcas.throwFeatMissing("canonical", "gov.va.queri.types.DictMatch");
  ...
  public String getCode(int addr) {
      ...
      jcas.throwFeatMissing("code", "gov.va.queri.types.DictMatch");
  ...
  public String getVocabulary(int addr) {
      ...
      jcas.throwFeatMissing("vocabulary", "gov.va.queri.types.DictMatch");
  ...
  public int getContainer(int addr) {
      ...
      jcas.throwFeatMissing("container", "gov.va.queri.types.DictMatch");
