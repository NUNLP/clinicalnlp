...
TypeDescription_impl negscopeterminator = new TypeDescription_impl('clinicalnlp.types.NegationScopeTerminator', '',
        'uima.tcas.Annotation')
...
// Segment types
//-----------------------------------------------------------------------------
TypeDescription_impl segment = new TypeDescription_impl('clinicalnlp.types.Segment', '', 'uima.tcas.Annotation');
segment.addFeature('code', '', 'uima.cas.String');
segment.addFeature('codeSystem', '', 'uima.cas.String');
types.addType(segment)

TypeDescription_impl heading = new TypeDescription_impl('clinicalnlp.types.SegmentHeading', '', 'uima.tcas.Annotation')
...
// Dictionary types
//-----------------------------------------------------------------------------
TypeDescription_impl dictMatch = new TypeDescription_impl('clinicalnlp.types.DictMatch', '', 'uima.tcas.Annotation')
